...
<html lang="en">
<head>
    <title>Contact Us - XAMPERE</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="container-fluid contactcontainer">
            ...
            <h6 class="ctag">We'd love to help you.</h6>

            <div class="contact row">
                <div class="col-sm-4 ccol">
                    <h1>Address</h1>
                    <p>Idea Lab, Technical Business Incubator, Hapur ByPass, Ghaziabad. 201009</p>
                </div>

                <div class="col-sm-4 ccol">
                    <h1>Contact</h1>
                    <p>+91 7500 813 655<br>+91 7905 129 106</p>
                </div>
                <div class="col-sm-4 ccol">
                    <h1>Email</h1>
                    <p>contact@xampere.com</p>
                    <p>avinash@xampere.com</p>
                </div>
            </div>

            <div class="footer cfooter">
                <ul class="pagelinks">
